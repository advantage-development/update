    ...
    filter(0)
{
    ...
    connect(ui->sendPaymentTransferButton, SIGNAL(clicked()), this, SIGNAL(sendPaymentTransferButtonClicked()));
}
...
{
    QString link="https://advantage-ledger.com";
    QDesktopServices::openUrl(QUrl(link));
}

void OverviewPage::on_pushButton_3_clicked()
{
    QString link="https://discord.gg/vFGNePp";
	QDesktopServices::openUrl(QUrl(link));
}

void OverviewPage::on_pushButton_4_clicked()
{
    QString link="t.me//advantagecommunity";
    QDesktopServices::openUrl(QUrl(link));
}
