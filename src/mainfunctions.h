...
static const int64_t DARKSEND_COLLATERAL = (1.00*CREDIT);
static const int64_t DARKSEND_POOL_MAX = (4999.99*CREDIT); //Darksend will be deleted in future iterations.

static const int64_t STATIC_POS_REWARD = 1 * CREDIT; //reward of 1 USDA + Fees
...
static const unsigned int MAX_BLOCK_SIZE = 400000000;//400MB 
...
static const int64_t MAX_MONEY = 50010000000 * CREDIT; 
...
//Masternode call, currently set to 5000 USDA collateral at block 210,000 changing to 1,000,000
...
inline bool AllowFree(double dPriority)
{
    ...
    // need a fee.
    return dPriority > CREDIT * 576 / 250;
}
