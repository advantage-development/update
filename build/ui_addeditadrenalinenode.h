...
public:
    ...
    void retranslateUi(QDialog *AddEditAdrenalineNode)
    {
        ...
        label_9->setText(QApplication::translate("AddEditAdrenalineNode", "<html><head/><body><p>Enter a fun and friendly nickname for your Masternode with the respective address IP and port number (53211). The address should be in the format 123.456.789.123:53211. You must send exactly 5,000 USDA to your Masternode collateral address.</p></body></html>", nullptr));
